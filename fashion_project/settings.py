...
SECRET_KEY = 'django-insecure-woyk2^scr#@24oznz!@#e!2inb6rd6hti4l@-tcgq2m6ywb-u-'
...
#     }
# }
# Redefine the database settings to connect to the PostgreSQL container
DATABASES = {
    "default": {
...
# Define drf spectacular settings
